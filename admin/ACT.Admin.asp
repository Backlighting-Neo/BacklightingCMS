...
<% 
 ...
 End If 
	...
	Dim arrRecordInfo, i
	Dim sql, sqlCount
	sql = "SELECT [ID], [Admin_Name], [SuperTF], [LoginTime], [LoginIP], [LoginNumber], [Locked],[RealName]" & _
		" FROM [Admin_ACT]"& _
		"ORDER BY [ID] DESC"
...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" class="table">
  ...
  <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" class="table">
    <tr>
      <td colspan="9" class="bg_tr">您现在的位置：系统设置 &gt;&gt; <a href="?"><font class="bg_tr">管理员管理</font></a></td>
    </tr>
    <tr>
      <td width="115" align="center" >管理员</td>
      <td width="111" align="center" >真实姓名</td>
    ...
    <tr onMouseOver=overColor(this) onMouseOut=outColor(this)>
      ...
      <td align="center"  ><%= arrRecordInfo(7,i) %></td>
      <td align="center"  >
	   <%IF arrRecordInfo(2,i) = 1 Then Response.Write "<font color=red>超级管理员</font>" Else Response.Write "普通管理员" %>      </td>
      <td align="center" ><%= arrRecordInfo(3,i) %></td>
      <td align="center"  ><%= arrRecordInfo(4,i) %></td>
      <td align="center" ><%= arrRecordInfo(5,i) %></td>
      <td align="center" >
	   <%IF arrRecordInfo(6,i) = 1 Then Response.Write "<font color=red>已锁定</font>" Else Response.Write "正常" %>	  </td>
      <td align="center" >       
