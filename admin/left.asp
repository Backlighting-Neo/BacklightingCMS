...
%>
 ...
 If Not  ACTCMS.ChkAdmin() Then  Exit Function '超级管理员检测
   ...
   xtsz=xtsz&"		<TD width=""2%""><IMG src=""Images/closed.gif""></TD>"& vbCrLf
   xtsz=xtsz&"		<TD height=""23"">"& vbCrLf
   xtsz=xtsz&"		<A href=""ACT_Mode/ACT.Recyle.asp?Type=New"" target=main>回收站管理</A></TD>"& vbCrLf
   xtsz=xtsz&" </TR>"& vbCrLf
  ...
  End Function 
	...
	Function Mxlist()
					...
					Mxlist=Mxlist&"			<td><img src=""Images/closed.gif"" /></td>"& vbCrLf
					Mxlist=Mxlist&"			<td height=""23"">"& vbCrLf
					Mxlist=Mxlist&"				<a href=""ACT_Mode/ACT.Recyle.asp?Type=New&ModeID="&ModeID&""" target=""main"">回收站管理</td>"& vbCrLf
					Mxlist=Mxlist&"		</tr>"& vbCrLf
  ...
  End Function 
  Function labellist()
  If Not  ACTCMS.ACTCMS_QXYZ(0,"bqxt","") Then  Exit Function 

	   labellist=labellist&"<tr>"& vbCrLf
	   labellist=labellist&"<td colSpan=2><TABLE width=""95%"" border=0 align=right cellPadding=0 cellSpacing=0 class=leftframetable>"& vbCrLf
	   labellist=labellist&"<TBODY>"& vbCrLf
	   labellist=labellist&"<TR>"& vbCrLf
	   labellist=labellist&"<TD width=""2%""><IMG height=17 src=""Images/main.gif"" width=15></TD>"& vbCrLf
	   labellist=labellist&"<TD class=STYLE1 style=""CURSOR: hand"" onclick=showsubmenu(5); width=""98%"" height=25>标签系统</TD>"& vbCrLf
	   labellist=labellist&"</TR>"& vbCrLf
	   labellist=labellist&"<TR>"& vbCrLf
	   labellist=labellist&" <TD colSpan=2><TABLE id=submenu5 cellSpacing=0 cellPadding=0 width=""100%"" border=0>"& vbCrLf
	   labellist=labellist&" <TBODY>"& vbCrLf



	   labellist=labellist&"<TR>"& vbCrLf
       labellist=labellist&"    <TD width=""2%""><IMG src=""Images/closed.gif""></TD>"& vbCrLf
       labellist=labellist&"    <TD height=23><A href=""Label_Admin.asp?Type=1""  target=main>系统函数标签</A> </TD>"& vbCrLf
       labellist=labellist&" </TR>"& vbCrLf
 
 
	   labellist=labellist&"<TR>"& vbCrLf
       labellist=labellist&"    <TD width=""2%""><IMG src=""Images/closed.gif""></TD>"& vbCrLf
       labellist=labellist&"    <TD height=23><A href=""Label_Admin.asp?Type=2""  target=main>自定义静态标签</A> </TD>"& vbCrLf
       labellist=labellist&" </TR>"& vbCrLf
 
	   labellist=labellist&"<TR>"& vbCrLf
       labellist=labellist&"    <TD width=""2%""><IMG src=""Images/closed.gif""></TD>"& vbCrLf
       labellist=labellist&"    <TD height=23><A href=""Label_Admin.asp?Type=3""  target=main>自由标签</A> </TD>"& vbCrLf
       labellist=labellist&" </TR>"& vbCrLf
 
	   labellist=labellist&"<TR>"& vbCrLf
       labellist=labellist&"    <TD width=""2%""><IMG src=""Images/closed.gif""></TD>"& vbCrLf
       labellist=labellist&"    <TD height=23><A href=""include/Label/ACT.LabelFolder.asp""  target=main>标签目录</A> </TD>"& vbCrLf
       labellist=labellist&" </TR>"& vbCrLf
 
	   labellist=labellist&"	         </tbody>"& vbCrLf
	   labellist=labellist&"	       </table></td>"& vbCrLf
	   labellist=labellist&"	     </tr>"& vbCrLf
	   labellist=labellist&"	   </tbody>"& vbCrLf
	   labellist=labellist&"	  </table></td>"& vbCrLf
	   labellist=labellist&"	 </tr>	"& vbCrLf
	   labellist=labellist&"		  <tr>"& vbCrLf
	   labellist=labellist&"	  <td bgcolor=""#9BC2ED""></td>"& vbCrLf
	   labellist=labellist&"	 </tr>"& vbCrLf
	   labellist=labellist&"	 <tr>"& vbCrLf
	   labellist=labellist&"	    <td bgcolor=""#9BC2ED""  height=""5""></td>"& vbCrLf
	   labellist=labellist&"	  </tr>"& vbCrLf
  End Function 
  ...
  Function pluslist()
	  ...
	  If Not Rs1.EOF  Then
		Do While Not Rs1.EOF	
			...
			If UBound(PlusMenu)<>UBound(PlusUrl) Then response.write Rs1("PlusName")&"插件管理地址错误":Exit For 
...
response.write " <tr>"& vbCrLf
response.write " <td height=""8"" colSpan=2>"& vbCrLf
response.write " <TABLE class=leftframetable cellSpacing=1 cellPadding=1 width=""95%"" align=right border=0>"& vbCrLf
response.write " <TBODY><TR><TD width=""2%""><IMG height=17 src=""Images/main.gif"" width=15></TD><TD class=STYLE1 width=""98%"" height=25>系统信息</TD>"& vbCrLf
response.write " </TR><TR><TD colSpan=2 height=50><span class=""STYLE2""><IMG src=""Images/closed.gif"">版权所有：逆光软件工作室<br>"& vbCrLf
response.write " <IMG src=""Images/closed.gif"">技术支持：逆光<br>"& vbCrLf
response.write " <IMG src=""Images/closed.gif"">系统版本：20130904 utf-8</span></TD>"& vbCrLf
response.write " </TR></TBODY></TABLE></td></tr></table></body></html>"& vbCrLf
%>
