...
If request("A") <> "" Then
	...
	cs=request("cs")
			...
			select case request("A")
				...
				case "del"	'删除、清空、批量删除
					'============添加管理员日志=====================
					ShortDescription="删除文章"
					LongDescription="删除的文章编号为"+cstr(ID)
...
<%	sub isAccept()'批量审核通过
	...
	sql = "SELECT [ID], [Title], [ArticleInput], [Hits], [isAccept], [IStop],  [ClassID], [FileName],[ACTLINK],[Ismake],[InfoPurview],[ReadPoint],[picurl],[Slide],[ATT],[rev],[UserID],[OrderID]" & _
		...
		"ORDER BY [IsTop] DESC,[UpdateTime] DESC,[OrderID] desc,[ID] DESC "
...
<form name="Article" method="post" Action="?ModeID=<%= ModeID %>">
   <input type="hidden" name="Action" value="batch">
    ...
    <tr>
      <td width="28px" align="center" class="bg_tr">选中 </td>
      <td width="40px" align="center" class="bg_tr">ID</td>
      <td width="40px" align="center" class="bg_tr">排序</td>
      <td width="160px" align="center" class="bg_tr">文章标题</td>
	  <td width="60px" align="center" class="bg_tr">栏目</td> 
	  <td width="60px" align="center" class="bg_tr">录入者</td> 
	  <td width="40px" align="center" class="bg_tr">点击数</td> 
	  <td width="28px" align="center" class="bg_tr">审核</td> 
	  <td width="28px" align="center" class="bg_tr">生成</td> 
      <td width="auto" colspan="2" align="center" class="bg_tr">管理操作</td>
    </tr>
	 <%
		Dim bgColor
    ...
    <tr onMouseOver=overColor(this) onMouseOut=outColor(this)>
      ...
      <td align="center" >
	  <input name="OrderID" type="text" class="Ainput" id="OrderID" value="<%= arrRecordInfo(17,i) %>" size="4" maxlength="3">
