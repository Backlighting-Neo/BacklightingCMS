...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" class="table">
  <form name="form1" method="post" action="Index.asp">
	...
	<input name="button"  onClick="J('#scs').dialog({ id:'actcmsscs' ,page: 'include/Upload_Admin.asp?A=0&instr=999&ModeID=1&instrname=PicIndex',  width:720, height:240 });"   id="scs"   type="button"  class="ACT_btn" style="cursor:hand;" value="点击上传图片"></td>
    </tr>
...
so.addVariable('upUrl','<%=ACTCMS.ACTSYS%><%=ACTCMS.ActCMS_Sys(8)%>/Special/Upload.asp');
...
var actup=t.split('|');
 {	   document.getElementById('actcms').value+=actup[1]+"|";
...
<input name="actcms" type="hidden" id="actcms"  value=""></td>
</tr>
