...
Select Case Trim(errnum)
	...
	Case "2"
		Title ="<li>操作成功</li>":ErrorPic = "√":Response.Write ("<script>parent.frames['menu'].location.reload();</script>")
	Case "3"
		Title ="<li>错误信息</li>":ErrorPic = "×":Helps = "请仔细阅读帮助文件？":Response.Write ("<script>parent.frames['menu'].location.reload();</script>")
	Case "4"
		Title ="<li>操作成功</li>":ErrorPic = "√":Response.Write ("<script>parent.frames['menu'].location.reload();</script>"):Response.Write ("<script>parent.frames['top'].location.reload();</script>")
	Case Else 
	Title="<li>错误信息</li>"
	ErrorPic = "×"
	Helps = "请仔细阅读帮助文件？"
