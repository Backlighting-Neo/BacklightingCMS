...
Const DownLoad_URL="http://download.actcms.com/Theme/List.asp?"
Const Resource_URL="http://download.actcms.com/Theme/Update.asp?theme="    '注意. Include 文件里还有一同名变量要修改
Const Update_URL="http://themes.actcms.com/Theme/download.asp?theme="
