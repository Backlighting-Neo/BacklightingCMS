...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" class="table">
  <tr>
    <td class="bg_tr">您现在的位置：主题样式  &gt;&gt; 浏览</td>
  </tr>
  <tr>
    <td>
    <div class="md-head" >
        <div class="zsj"></div>
<a href="Act.Theme.ACTList.asp" class="a10 wrap cur wid"  >在线安装主题</a>
<a href="Act.Theme.Reg.asp" class="a10 wrap"  >我的帐号</a>
<a href="Index.asp" class="10 wrap"  >主题管理</a>
<a href="Act.Theme.Check.asp" class="a10 wrap"  >查看主题的可用更新</a>
  ...
  <%If Action <> "install" Then
 	Echo "<div class=""top1""><span style="" margin-left:10px"" ><strong>提示：</strong>下面列出了""在线模版""里提供的主题资源, 您可以通过点击<b> [安装主题] </b>将您需要的主题安装到您的系统上.</span></div>"
End If
%> <%
...
<input onclick="self.location.href='Index.asp';" type="button"  class="ACT_btn"  value="返回主题管理" title="返回主题管理页" /> <input onclick="window.scrollTo(0,0);" type="button"  class="ACT_btn"   value="返回页面顶部"  title="返回页面顶部" /></form>
