...
<a href="Act.Theme.Check.asp" class="a10 wrap"  >查看主题的可用更新</a>
 ...
 <div class="top1"><span style=" margin-left:10px" ><strong>提示：</strong>修改 ID 为<%=SelectedTheme%> 的主题的信息文档.&nbsp;&nbsp; Theme.xml 文件, 该文件将位于主题目录内
</span></div>
</td>
  </tr>
</table>
 ...
 <%
	...
	Response.Flush
 	  ...
 	  End If 
   	  End If
 	If fso.FileExists(Tpath & ThemePath& SelectedTheme & "/" & "preview.gif") Then
		ThemeScreenShot="../../../" &ThemePath&SelectedTheme & "/" & "preview.gif"
	Else
		ThemeScreenShot="Images/nopreview.jpg"
	End If
   	If fso.FileExists(Tpath & ThemePath & ThemeID & "/" & "verchk.xml") Then
		echo "<p><a class=""notice"" href=""Act.Theme.Install.Asp?act=update&amp;url=" & Server.URLEncode(Update_URL & ThemeID) & """ title=""升级主题""><b >发现该主题的新版本!</b></a></p><br />"&vbCrLf
	ElseIf fso.FileExists(Tpath & ThemePath & ThemeID & "/" & "error.log") Then
		echo "<p><b class=""notice"">该主题不支持在线更新.</b></p><br />"&vbCrLf
	End If
...
%>
  <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" class="table">
  <form method="post" action="Act.Theme.ThemeInstall.asp?act=ThemesSav">
 


    <tr>
      <td width="20%" height="35" align="right">主题ID&nbsp;&nbsp;</td>
      <td width="46%" height="35"><% 	
	  If UCase(ThemeID)<>UCase(SelectedTheme) Then
		echo "该主题ID错误, 请 <a href=""Act.Theme.Edit.asp?theme=" & Server.URLEncode(SelectedTheme) & """ title=""编辑主题信息""><font color=""red""><b>[重新编辑主题信息]</b></font></a>"&vbCrLf
	Else
		echo  ThemeID &vbCrLf
	End If
	%>
    ...
    <tr>
      <td height="35" align="right">主题名称&nbsp;&nbsp;</td>
    ...
    <tr>
      ...
      <td height="35"><%="<a href=""" & ThemeURL & """ target=""_blank"" title=""主题的发布地址"">" & ThemeURL & "</a>"%>        </td>
    </tr>
    <%End If %>
    ...
    <tr>
      <td height="35" align="right">主题作者&nbsp;&nbsp;</td>
      <td height="35"><%
...
%>  </td>
 ...
 <tr>
      <td height="35" align="right">主题简介&nbsp;&nbsp;</td>
 ...
 <tr>
      <td height="35" align="right">主题版本&nbsp;&nbsp;</td>
 ...
 <tr>
      <td height="35" align="right">主题源作者&nbsp;&nbsp;</td>
 ...
 <tr>
      <td height="35" align="right">编辑主题信息&nbsp;&nbsp;</td>
      <td height="35"><%="<a href=""Act.Theme.Edit.asp?theme=" & Server.URLEncode(ThemeID) & """ title=""编辑主题信息"">[编辑主题信息]</a>:</b> 此功能可用于生成或编辑该主题的信息文档 Theme.xml"%>  </td>
      <td>&nbsp;</td>
 </tr>
 
  	
 <tr>
      <td height="35" align="right">升级修复主题&nbsp;&nbsp;</td>
      <td height="35"><%="<a href=""Act.Theme.Install.Asp?act=update&amp;url=" & Server.URLEncode(Update_URL & ThemeID) & """ title=""升级修复主题"">[升级修复主题]</a>"%>  </td>
      <td>&nbsp;</td>
 </tr>
 
  	
 <tr>
      <td height="35" align="right">删除主题&nbsp;&nbsp;</td>
      <td height="35"><%="<a href=""Index.asp?act=themedel&amp;theme=" & Server.URLEncode(SelectedTheme) & "&amp;themename=" & Server.URLEncode(ThemeName) & """ title=""删除此主题"" onclick=""return window.confirm('您将删除此主题的所有文件, 确定吗?');"">[删除主题]</a>"%>  </td>
      <td>&nbsp;</td>
 </tr>
 ...
 <tr>
	...
	<%
	   	echo "<p><input type=""submit"" class=""ACT_btn"" value="" 应用此主题 ""   /> <input onclick=""self.location.href='Index.asp';"" type=""button"" class=""ACT_btn"" value="" 返回主题管理 ""   /></p>"&vbCrLf
  	echo "</form>"&vbCrLf
 	Set fso = nothing
	Err.Clear
