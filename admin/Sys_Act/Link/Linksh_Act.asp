...
dim sitename
  ...
  <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" class="table">
    ...
    <tr>
      ...
      <td  class="td_bg"><input  <% IF locked = 0 Then Response.Write "Checked" %> type="radio" id="locked1" name="locked" value="0"><label for="locked1">正常</label>
    ...
    <tr>
      ...
      <td  class="td_bg"><input  <% IF rec = 0 Then Response.Write "Checked" %> type="radio" id="radio" name="rec" value="0"><label for="radio">是</label>
