...
<form name="form1" method="post" action="Index.asp?Action=editsave&CID=<%=ID  %>">  <tr>
     ...
     <tr>
       <td height="25" align="right"><strong>投票方式</strong><b>：</b></td>
       <td>   
        <input title="设置单选投票" type="radio" name="VoteType" id="VoteType1" value="0"   <% if rs("VoteType")="0" then response.Write "Checked" %>><label for="VoteType1">单选</label>
      &nbsp;&nbsp;
    <input title="设置多选投票" type="radio" name="VoteType" id="VoteType2" value="1"  <% if rs("VoteType")="1" then response.Write "Checked" %> ><label for="VoteType2">多选</label> </td>
</td>
     </tr>
     <tr>
       <td height="25" align="right"><strong>是否锁定</strong><b>：</b></td>
       <td> <label for="isLock1"><input type="radio" name="isLock"  id="isLock1" value="0"   <% if rs("isLock")="0" then response.Write "Checked" %>>否</label>
    &nbsp;&nbsp;
    <label for="isLock2"><input type="radio" name="isLock"  id="isLock2"  value="1"   <% if rs("isLock")="1" then response.Write "Checked" %>>是</label></td>
     </tr>
     <tr>
       <td height="25" align="right"><strong>投票时间</strong><b>：</b></td>
       <td>&nbsp;开始于
