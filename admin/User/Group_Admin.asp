 ...
 %>
  <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" class="table">
    ...
    <tr onMouseOver=overColor(this) onMouseOut=outColor(this)>
      ...
      <td align="center"  >
	  <%If ifd=2 Then 
		response.write Conn.Execute("Select Count(UserID) From User_act Where GroupID=" & arrU(0,i))(0)
		End If %></td>
      <td  align="center" >
...
Sub Edit()
	...
	IF Action = "Edit" Then
		...
		IF GroupID = 0 Then Response.Write "请指定要修改的用户组ID":Response.End
		Set Rs=Conn.Execute("Select * from Group_ACT Where GroupID=" & GroupID)
			if Rs.Bof And Rs.EOF then
				 Response.Write "不存在此用户组！"
				Exit Sub
			End IF	
...
<form name="form1" method="post" action="Group_Admin.asp">
    ...
    <tr>
      ...
      <td ><INPUT type="checkbox"  <%if fbpl= "1" Then Response.Write "Checked "%> value="1" id="GroupSetting33" name="GroupSetting3"><label for="GroupSetting33">
        在禁止发表评论的栏目里仍然可发表评论</label><BR>
       <label for="GroupSetting44"> <INPUT <%if sh= 1 Then Response.Write "Checked "%>  type="checkbox"  id="GroupSetting44"  value="1" name="GroupSetting4">
...
人</td>
	...
	<tr>
      ...
      <td ><INPUT id="GroupSetting88" type="radio" <%if scwj= "1" Then Response.Write "Checked "%>  value="1" name="GroupSetting8"><LABEL for="GroupSetting88">允许</LABEL>
        <INPUT id="GroupSetting78" type="radio"  <%if scwj= "0" Then Response.Write "Checked "%>  value="0" name="GroupSetting8"><LABEL for="GroupSetting78">不允许</LABEL></td>
    </tr>
    ...
    <tr>
      ...
      <td >
	    <INPUT id="GroupSetting12" type="radio" <%if fbsh= "1" Then Response.Write "Checked "%> value="1" name="GroupSetting12"><LABEL for="GroupSetting12">是</LABEL>
        <INPUT id="GroupSetting121" type="radio" <%if fbsh= "0" Then Response.Write "Checked "%>  value="0" name="GroupSetting12"><LABEL for="GroupSetting121">否</LABEL>
		</td>
    </tr>
    <tr>
      <td align="right" >注册认证：</td>
      <td >
	    <INPUT id="GroupSetting13" type="radio" <%if zcrz= "1" Then Response.Write "Checked "%> value="1" name="GroupSetting13"><LABEL for="GroupSetting13">不验证</LABEL>
        <INPUT id="GroupSetting131" type="radio" <%if zcrz= "2" Then Response.Write "Checked "%>  value="2" name="GroupSetting13"><LABEL for="GroupSetting131">邮件验证</LABEL>
        <INPUT id="GroupSetting1312" type="radio" <%if zcrz= "3" Then Response.Write "Checked "%>  value="3" name="GroupSetting13"><LABEL for="GroupSetting1312">后台验证</LABEL>
	</td>
    </tr>
