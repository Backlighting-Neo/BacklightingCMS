...
if request("Action")="create" then
	...
	If IsArray(MX_Sys) Then
		For j=0 To Ubound(MX_Sys,2)
			...
			SqlStr="select top " & prioritynum & "   ClassID,ID,ActLink,FileName,infopurview,readpoint,title,UpdateTime "
			...
			for i=1 to rs.RecordCount
				...
				xmlstr=xmlstr&"        <loc>"&ACTCMS.GetInfoUrlall(MX_Sys(0,j),Rs(0),Rs(1),Rs(2),Rs(3),Rs(4),Rs(5))&"</loc>"&vbcrlf
