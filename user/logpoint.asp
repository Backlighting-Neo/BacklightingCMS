...
<% 
 ...
 <tr>
    ...
    <td class="splittd" align="right"><%if arrRecordInfo(5,I)=1 Then Response.Write arrRecordInfo(4,I) & "点":InPoint=InPoint+arrRecordInfo(4,I) ELSE Response.Write "-"%></td>
    <td class="splittd" align="right"><%if arrRecordInfo(5,I)=2 Then Response.Write arrRecordInfo(4,I) & "点":OutPoint=OutPoint+arrRecordInfo(4,I) ELSE Response.Write "-"%></td>
